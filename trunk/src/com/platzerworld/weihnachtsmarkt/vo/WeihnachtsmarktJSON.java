...
public class WeihnachtsmarktJSON  implements Serializable{
	private static final long serialVersionUID = 6869160557458781385L;
	
	private String biergartenid = "GPL";
	private List<WeihnachtsmarktVO> biergartenListe = new ArrayList<WeihnachtsmarktVO>();
	...
	public List<WeihnachtsmarktVO> getBiergartenListe() {
		return biergartenListe;
	}
	public void setBiergartenListe(List<WeihnachtsmarktVO> biergartenListe) {
